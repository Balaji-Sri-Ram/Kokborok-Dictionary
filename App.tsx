        ...
        <div className="max-w-7xl mx-auto px-4 h-16 grid grid-cols-3 items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.h1 
              ...
              className="text-lg font-bold text-slate-800 dark:text-zinc-100 tracking-tight hidden lg:block"
            >
          ...
          <div className="flex items-center justify-end gap-3 transition-all">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener" 
              className="p-2 text-slate-400 hover:text-indigo-600 dark:text-zinc-500 dark:hover:text-violet-400 transition-colors"
            >
              <Info size={18} />
            </a>
            <LanguageSelector />
